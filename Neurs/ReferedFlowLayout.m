...
static NSString * const ReferredLayoutPhotoCellKind = @"ReferredCell";
@implementation ReferedFlowLayout
...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < sectionCount; section++) {
        ...
        for (NSInteger item = 0; item < itemCount; item++) {
            ...
            itemAttributes.frame = [self frameForReferredAtIndexPath:indexPath];
            
            cellLayoutInfo[indexPath] = itemAttributes;
        }
    }
    
    newLayoutInfo[ReferredLayoutPhotoCellKind] = cellLayoutInfo;
...
- (CGRect)frameForReferredAtIndexPath:(NSIndexPath *)indexPath
{
...
{
    return self.layoutInfo[ReferredLayoutPhotoCellKind][indexPath];
}
